...
<?php
//Add new bone-individual association
$qry = "INSERT INTO bone_individual (bone_id, individual_id) VALUES ((SELECT bone_id FROM bone WHERE bone_number = :boneNumber), :individualID)";
