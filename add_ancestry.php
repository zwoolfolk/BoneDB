...
<?php
//Add new bone-ancestry association
$qry = "INSERT INTO bone_ancestry (bone_id, ancestry_id) VALUES ((SELECT bone_id FROM bone WHERE bone_number = :boneNumber), :ancestryType)";

$stmt = $pdo->prepare($qry);

$stmt->bindParam(':boneNumber', $_POST['BoneNumber']);
$stmt->bindParam(':ancestryType', $_POST['BoneAncestry']);
